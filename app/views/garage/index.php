        ...
        <article>
          <header class="section background-white">
            <div class="line text-center">        
              <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">Car Showroom</h1>
              <p class="margin-bottom-0 text-size-16 text-dark">Manage your car showroom from home<br>
              easier than ever</p>
            </div>  
          </header>
