<!-- FOOTER -->
    ...
    <script type="text/javascript" src="<?=ASSETS?>garage/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>garage/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>garage/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>garage/js/template-scripts.js"></script> 
  </body>
</html>