<?php $this->view("garage/header",$data);?>
          ...
          <section class="section background-white">
            ...
            <div class="s-12 m-12 l-4 center">
              <h4 class="text-size-20 margin-bottom-20 text-dark text-center">Upload Your Car Details</h4>
              <form method="post" enctype="multipart/form-data" name="contactForm" class="customform" method="post">
                 
                <div class="s-12"> 
                  <input name="title" class="subject" placeholder="Car Model" title="Title" type="text" required>
                  <p class="subject-error form-error">Please enter the Car Model.</p>
                </div>
                <div class="s-12"> 
